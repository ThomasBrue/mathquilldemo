...
JS environment could actually contain many instances. */
  ...
  function getInterface(v) {
    ...
    var AbstractMathQuill = (APIClasses.AbstractMathQuill = P(
      Progenote,
      function (_) {
        ...
        _.__mathquillify = function (classNames) {
          ...
          root.jQ = $('<span class="mq-root-block" style="padding: 10px;"/>')
  ...
  Controller.open(function (_) {
    ...
    _.delegateMouseEvents = function () {
      console.log("delegateMouseEvents");
  ...
  Controller.open(function (_) {
    ...
    _.staticMathTextareaEvents = function () {
      ...
      this.container.prepend(
        jQuery('<span class="mq-selectable">').text(
          "$" + ctrlr.exportLatex() + "$"
        )
      );
      ctrlr.blurred = true;
    ...
    */
    ...
    _.html = function () {
      ...
      return tokens.join("").replace(/>&(\d+)/g, function ($0, $1) {
        return (
          " mathquill-block-id=" + blocks[$1].id + ">" + blocks[$1].join("html")
        );
      });
    };
  ...
  API.TextField = function (APIClasses) {
    return P(APIClasses.EditableField, function (_, super_) {
      ...
      _.__mathquillify = function () {
        return super_.__mathquillify.call(
          this,
 ...
 */
  ...
  var Letter = P(Variable, function (_, super_) {
    ...
    _.finalizeTree = _.siblingDeleted = _.siblingCreated = function (
      opts,
      dir
    ) {
  ...
  (function () {
    ...
    for (var i = 0; i < autoTrigs.length; i += 1) {
      AutoOpNames[autoTrigs[i]] = AutoOpNames[
        "arc" + autoTrigs[i]
      ] = AutoOpNames[autoTrigs[i] + "h"] = AutoOpNames[
        "ar" + autoTrigs[i] + "h"
  ...
  LatexCmds.phiv = LatexCmds.varphi = bind(Variable, "\\varphi ", "&phi;"); //Elsevier and 9573-13 //AMS and LaTeX
...
LatexCmds.integral = P(SummationNotation, function(_, super_) {
  ...
  var SquareRoot = (LatexCmds.sqrt = LatexCmds["√"] = P(MathCommand, function (
    _,
    super_
  ) {
    _.ctrlSeq = "\\sqrt";
  ...
  var Matrix = (Environments.matrix = P(Environment, function (_, super_) {
    var delimiters = {
      column: "&",
      row: "\\\\",
    };
    ...
    _.reflow = function () {
      ...
      var height =
        blockjQ.outerHeight() / +blockjQ.css("fontSize").slice(0, -2);
    ...
    _.latex = function () {
      ...
      this.eachChild(function (cell) {
        if (typeof row !== "undefined") {
          latex += row !== cell.row ? delimiters.row : delimiters.column;
        }
        row = cell.row;
        latex += cell.latex();
      });
  ...
  //------LatexCommandInput.js----------------------------------------------------------------------------------------------------------------

  /****************************************
   * Input box to type backslash commands
   ***************************************/

  var LatexCommandInput = (CharCmds["\\"] = P(MathCommand, function (
    _,
    super_
  ) {
    _.ctrlSeq = "\\";
